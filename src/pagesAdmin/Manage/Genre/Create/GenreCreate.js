...
function GenreCreate() {
    ...
    const handleCreateGenre = async () => {
        try {
            ...
            dispatch(noticeAdminSlice.actions.processingNotice('Đang thêm thể loại'));
            ...
            const res = await axios.post(`${process.env.REACT_APP_API_URL}/v1/genre/create`, formData);
    
            if(res.data.success) {
                dispatch(noticeAdminSlice.actions.successNotice('Thêm thể loại thành công'));
