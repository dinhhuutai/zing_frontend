...
function Table({
    ...
    useEffect(() => {
        ...
        if(newArray.length === artists.length && artists.length !== 0) {
                        ...
                        return (
                            ...
                            >
                                <td className="w-[30px] border-r-solid border-r-[1px] border-r-[#c4b8b8] flex justify-center items-center">
                                    <input checked={listCheck.includes(index)} onChange={(e) => handleCheckItem(index, e)} data-id={listCheck.includes(index) ? artist._id : null} name="inputCheckboxArtistList" type="checkbox" />
                                </td>
                                ...
                                <td className='w-[200px]'>
                                    <Link to={`${config.routes.adminArtistUpdate}/${artist._id}`} className="w-full h-full cursor-pointer border-r-solid border-r-[1px] border-r-[#c4b8b8] flex items-center px-[10px] py-[4px]">
                                        {artist.name}
                                    </Link>
                                </td>
                                ...
                                <td className="w-[150px] border-r-solid border-r-[1px] border-r-[#c4b8b8] px-[10px] flex items-center py-[4px]">{`${new Date(
                                    artist.createDate,
                                ).getDate()}/${new Date(artist.createDate).getMonth() + 1}/${new Date(
                                    artist.createDate,
                                ).getFullYear()}`}</td>
                                <td className="w-[180px] flex items-center px-[10px] py-[4px]">{`${new Date(
                                    artist.contentLastUpdate,
                                ).getDate()}/${new Date(artist.contentLastUpdate).getMonth() + 1}/${new Date(
                                    artist.contentLastUpdate,
                                ).getFullYear()}`}</td>
                            </tr>
                        );
