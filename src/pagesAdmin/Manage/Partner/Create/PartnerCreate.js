...
function PartnerCreate() {
    ...
    const handleCreateGenre = async () => {
        try {
            ...
            dispatch(noticeAdminSlice.actions.processingNotice('Đang thêm đối tác'));
            ...
            const res = await axios.post(`${process.env.REACT_APP_API_URL}/v1/partner/create`, formData);
    
            if(res.data.success) {
                dispatch(noticeAdminSlice.actions.successNotice('Thêm đối tác thành công'));
        ...
        <div>
            <div className="py-[16px] px-[60px] bg-[#F7F9FA] flex items-center justify-between">
                <div className="flex items-center gap-[20px]">
                    ...
                    <h1 className="text-[20px] text-[#5a5757]">Partner Create</h1>
                </div>
                <button
