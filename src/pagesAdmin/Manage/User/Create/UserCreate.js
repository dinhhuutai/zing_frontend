    ...
    const handleCreateArtist = async () => {
        try {
            ...
            const formData = {
                ...
                password,
                isAdmin,
                avatar: radioUp ? resLinkImg.data.link : image,
            }
        ...
        <div>
            <div className="py-[16px] px-[60px] bg-[#F7F9FA] flex items-center justify-between">
                <div className="flex items-center gap-[20px]">
                    ...
                    <h1 className="text-[20px] text-[#5a5757]">User Create</h1>
                </div>
                <button
                ...
                <div className='flex gap-[20px]'>
                    ...
                    <div className='flex flex-col gap-[4px] w-[50%]'>
                        ...
                        <div className='flex flex-col gap-[4px] mt-[14px]'>
                            <label>Password: <span className='text-[red] text-[14px] font-[700]'>*</span></label>
                            <input value={password} name='name' onChange={(e) => setPassword(e.target.value)} className='border-[1px] px-[8px] py-[2px] outline-none border-solid border-[#a9a5a5] rounded-[4px]' type="text" placeholder="Password" />
                        </div>
